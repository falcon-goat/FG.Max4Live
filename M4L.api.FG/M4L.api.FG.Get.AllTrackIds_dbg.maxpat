	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 488.0, 476.0, 50.0, 16.0 ],
					"id" : "obj-30",
					"fontname" : "Arial Bold",
					"outlettype" : [ "" ],
					"fontsize" : 10.0
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 488.0, 500.0, 24.0, 24.0 ],
					"id" : "obj-31",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 568.0, 476.0, 50.0, 16.0 ],
					"id" : "obj-28",
					"fontname" : "Arial Bold",
					"outlettype" : [ "" ],
					"fontsize" : 10.0
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 568.0, 500.0, 24.0, 24.0 ],
					"id" : "obj-29",
					"comment" : "Id of return tracks"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 656.0, 476.0, 50.0, 16.0 ],
					"id" : "obj-26",
					"fontname" : "Arial Bold",
					"outlettype" : [ "" ],
					"fontsize" : 10.0
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 656.0, 500.0, 24.0, 24.0 ],
					"id" : "obj-4",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 68.0, 548.0, 116.0, 18.0 ],
					"id" : "obj-22",
					"fontname" : "Arial Bold",
					"fontsize" : 10.0
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 153.5, 472.5, 665.5, 472.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 153.5, 472.5, 577.5, 472.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 153.5, 472.5, 497.5, 472.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 237.5, 396.5, 528.5, 396.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 297.5, 392.5, 608.5, 392.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 357.5, 388.5, 696.5, 388.5 ]
				}
