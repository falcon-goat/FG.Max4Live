...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 396.0, 544.0, 46.0, 18.0 ],
					"id" : "obj-20",
					"fontname" : "Arial Bold",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 144.0, 476.0, 67.0, 18.0 ],
					"id" : "obj-55",
					"fontname" : "Arial Bold",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 264.0, 416.0, 127.0, 16.0 ],
					"id" : "obj-52",
					"fontname" : "Arial Bold",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 416.0, 71.0, 16.0 ],
					"id" : "obj-36",
					"fontname" : "Arial Bold",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 436.0, 160.0, 16.0 ],
					"id" : "obj-33",
					"fontname" : "Arial Bold",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 84.0, 392.0, 128.0, 18.0 ],
					"id" : "obj-3",
					"fontname" : "Arial Bold",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"numoutlets" : 0,
					"patching_rect" : [ 144.0, 592.0, 25.0, 25.0 ],
					"id" : "obj-74",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"numoutlets" : 0,
					"patching_rect" : [ 168.0, 592.0, 25.0, 25.0 ],
					"id" : "obj-75",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"numoutlets" : 0,
					"patching_rect" : [ 192.0, 592.0, 25.0, 25.0 ],
					"id" : "obj-76",
					"numinlets" : 1,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 0.34902, 0.0, 1.0 ],
					"midpoints" : [ 105.5, 272.5, 273.5, 272.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 153.5, 390.5, 405.5, 390.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 93.5, 410.5, 153.5, 410.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-36", 0 ],
					"hidden" : 0,
					"midpoints" : [ 153.5, 398.5, 153.5, 398.5 ]
				}
