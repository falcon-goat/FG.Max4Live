{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 299.0, 217.0, 951.0, 506.0 ],
		"bglocked" : 0,
		"defrect" : [ 299.0, 217.0, 951.0, 506.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"numoutlets" : 0,
					"patching_rect" : [ 564.0, 424.0, 25.0, 25.0 ],
					"id" : "obj-4",
					"numinlets" : 1,
					"comment" : "Property: loop_length (BBT - interval)"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "M4L.api.FG.TranslateToClipBeatTime",
					"linecount" : 2,
					"color" : [ 0.756863, 0.329412, 0.843137, 1.0 ],
					"numoutlets" : 2,
					"fontsize" : 10.0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 564.0, 292.0, 111.0, 29.0 ],
					"id" : "obj-3",
					"fontname" : "Arial Bold",
					"numinlets" : 3
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 564.0, 136.0, 44.0, 18.0 ],
					"id" : "obj-2",
					"fontname" : "Arial Bold",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 564.0, 156.0, 44.0, 18.0 ],
					"id" : "obj-1",
					"fontname" : "Arial Bold",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 412.0, 292.0, 111.0, 29.0 ],
					"id" : "obj-53",
					"fontname" : "Arial Bold",
					"numinlets" : 3
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 32.0, 292.0, 111.0, 29.0 ],
					"id" : "obj-41",
					"fontname" : "Arial Bold",
					"numinlets" : 3
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 256.0, 292.0, 111.0, 29.0 ],
					"id" : "obj-20",
					"fontname" : "Arial Bold",
					"numinlets" : 3
				}
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 424.0, 25.0, 25.0 ],
					"id" : "obj-9",
					"numinlets" : 1,
					"comment" : "Property: playing_position (BBT - interval)"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-11",
					"numinlets" : 1,
					"comment" : "Property: loop_start (BBT - interval)"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"numoutlets" : 0,
					"patching_rect" : [ 412.0, 424.0, 25.0, 25.0 ],
					"id" : "obj-13",
					"numinlets" : 1,
					"comment" : "Property: loop_end (BBT - interval)"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-15",
					"numinlets" : 1,
					"comment" : "Property: playing_position (BBT - position)"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"numoutlets" : 0,
					"patching_rect" : [ 348.0, 424.0, 25.0, 25.0 ],
					"id" : "obj-16",
					"numinlets" : 1,
					"comment" : "Property: loop_start (BBT - position)"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"numoutlets" : 0,
					"patching_rect" : [ 504.0, 424.0, 25.0, 25.0 ],
					"id" : "obj-17",
					"numinlets" : 1,
					"comment" : "Property: loop_end (BBT - position)"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 17.5, 268.5, 41.5, 268.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 321.5, 282.5, 467.5, 282.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 0.0, 0.431373, 1.0 ],
					"midpoints" : [ 321.5, 282.5, 87.5, 282.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 0.0, 0.431373, 1.0 ],
					"midpoints" : [ 321.5, 282.5, 311.5, 282.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.047059, 0.0, 1.0, 1.0 ],
					"midpoints" : [ 518.5, 284.5, 513.5, 284.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.047059, 0.0, 1.0, 1.0 ],
					"midpoints" : [ 518.5, 284.5, 133.5, 284.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.047059, 0.0, 1.0, 1.0 ],
					"midpoints" : [ 518.5, 284.5, 357.5, 284.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 303.5, 252.5, 421.5, 252.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-20", 0 ],
					"hidden" : 0,
					"midpoints" : [ 250.833328, 258.5, 265.5, 258.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 303.5, 130.5, 573.5, 130.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 1 ],
					"hidden" : 0,
					"midpoints" : [ 250.833328, 132.5, 598.5, 132.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.047059, 0.0, 1.0, 1.0 ],
					"midpoints" : [ 518.5, 284.5, 665.5, 284.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 0.0, 0.0, 1.0 ],
					"midpoints" : [ 321.5, 282.5, 619.5, 282.5 ]
				}
